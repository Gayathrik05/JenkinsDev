...
//	}
	...
	public void adminLoginDetails() {
		...
		driverUserLogin.findElement(By.name("loginComponent")).click();
		driverUserLogin.findElement(By.name("userEmail")).sendKeys("admin@gmail.com");
		driverUserLogin.findElement(By.name("userPassword")).sendKeys("admin123");
		driverUserLogin.findElement(By.name("login")).click();
		System.out.println(driverUserLogin.getTitle());
		System.out.println("Register Successfully");
		driverUserLogin.close();
